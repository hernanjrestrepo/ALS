...
export default function EditStandardPage() {
    ...
    const fetchStandard = async () => {
        try {
            ...
            setFormData({ title: standard.title, description: standard.description, type: standard.type });
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.put(`/standards/${id}`, data, { headers: { 'Content-Type': 'multipart/form-data' } });
