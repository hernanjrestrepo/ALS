                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setFormData({ ...formData, oitType: e.target.value.toUpperCase() })
                                    }
                                    required
                                />
                        ...
                        <CardContent className="pt-6">
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex items-center justify-between py-2 border-b border-slate-100">
                                    ...
                                    <span className="font-medium text-slate-900">{formData.oitType || '-'}</span>
                                </div>
                                <div className="flex items-center justify-between py-2">
                                    <span className="text-slate-500">Pasos:</span>
                                    <span className="font-medium text-slate-900">{formData.steps.length}</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
